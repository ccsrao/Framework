...
public class ExtentConfigurations {
	...
	public static ExtentReports getExtentInstance(String reportsPath, String projectPath, String reportName) {
		...
		if (reports == null) {
			...
			reports.loadConfig(new File(environmentVariable + File.separator + "extent-config.xml"));
		}
		
		return reports;
	}
	/* Customizing the extent reports to configure the report header, report name and report head line*/
	public static String customizeTestngConfigFile(String reportName) {
		...
		String str = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" 
				...
				+ "    <reportName>Demo - </reportName>\r\n" + "\r\n"
				+ "    <!-- report headline - displayed at top-nav, after reportHeadline -->\r\n"
				+ "    <reportHeadline>AUTOMATION FRAMEWORK</reportHeadline>\r\n" + "\r\n"
	...
	/* Write the extent-config.xml file into framework*/
